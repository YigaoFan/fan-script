...
// import { EvalAfterIdInExpStmt, EvalExp, EvalFuncs, EvalInvocationCircle, EvalItems, EvalKey, EvalPairs, EvalParas, EvalRefinement, EvalStmt, EvalStmts, EvalVarStmt } from './EvalDispatch';
...
// export const EvalFun = function (func: Fun, env: Env, nextStepCont: OnlyNextStepCont) {
...
// /**
//  * @param cont use return cont to call as nested ExpStmt, 
//  * next step cont to call as complete standalone ExpStmt
//  */
// export const EvalExpStmt = function (stmt: ExpStmt, env: Env, cont: OnlyNextStepCont | OnlyReturnCont) {
//     assert('return' in cont || 'nextStep' in cont, 'conts must contain return or nextStep cont');
//     EvalId(stmt.id, env, {
//         return(varValueRef) {
//             EvalAfterIdInExpStmt(stmt.afterIdInExpStmt, varValueRef, env, {
//                 return: (valueRef) => {
//                     if ('return' in cont) {
//                         cont.return(valueRef);
//                     } else if ('nextStep' in cont) {
//                         cont.nextStep(env);
//                     }
//                 },
//             });
...
export const ParaTypeOfEvalRule: Record<string, [string, string][]> = {
    EvalFun: [['env', 'Env'], ['nextStepCont', 'OnlyNextStepCont']],
    ...
    EvalKey_0: [['env', 'Env'], ['retCont', 'OnlyReturnCont']],
    EvalKey_1: [['env', 'Env'], ['retCont', 'OnlyReturnCont']],
    ...
    EvalInvocation: [['fun', 'EvaledFunc'], ['env', 'Env'], ['returnCont', 'OnlyReturnCont']],
    ...
    EvalExpStmt: [['env', 'Env'], ['cont', 'OnlyNextStepCont | OnlyReturnCont']],
